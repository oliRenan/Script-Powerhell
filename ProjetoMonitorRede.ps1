...
$IP_DNS = Get-DnsActive
Write-Host "dns do ip_dns " + $IP_DNS
...
$latencyButton.Add_Click({
    ...
    $outputBox.Text += "Latencia media para "+(Get-DnsActive) + " = " +(Test-Latency) + " ms`n" 
})
